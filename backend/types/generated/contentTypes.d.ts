...
export interface ApiHippocrateHippocrate extends Struct.SingleTypeSchema {
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['season', 'off_season']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiThematicThematic extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Thematic';
    pluralName: 'thematics';
    singularName: 'thematic';
  };
  options: {
    draftAndPublish: true;
  };
