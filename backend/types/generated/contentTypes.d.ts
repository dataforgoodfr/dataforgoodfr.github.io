...
export interface ApiHippocrateHippocrate extends Schema.SingleType {
  collectionName: 'hippocrates';
  info: {
    singularName: 'hippocrate';
    pluralName: 'hippocrates';
    displayName: 'Hippocrate';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    cta_join: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cta_projects: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cta_donation: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    vision_description: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    mission_description: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    values_description: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    association_description: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    state: Attribute.Enumeration<['bient\u00F4t', 'en cours', 'termin\u00E9']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    impact_area: Attribute.JSON &
...
export interface ApiSeasonSeason extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['season', 'off_season']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
